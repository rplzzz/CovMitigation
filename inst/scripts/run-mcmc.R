...
scl_warmup <-
  structure(c(1.441, 1.167, 10.03, -1.925, -0.8166, -0.4529, -0.2993, 
              5.888, -6.574, 4.792, 1.167, 0.9665, 8.042, -2.045, -0.6536, 
              -0.3639, -0.2359, 4.591, -5.478, 3.948, 10.03, 8.042, 100, -5.292, 
              -4.696, -2.725, -1.412, 60.55, -37.41, 5.403, -1.925, -2.045, 
              -5.292, 100, 4.204, 1.135, 1.263, 8.568, 39.3, 37.21, -0.8166, 
              -0.6536, -4.696, 4.204, 1.227, 0.3574, 0.5296, -2.47, 7.437, 
              -1.95, -0.4529, -0.3639, -2.725, 1.135, 0.3574, 0.1927, 0.1486, 
              -1.449, 2.626, -1.473, -0.2993, -0.2359, -1.412, 1.263, 0.5296, 
              0.1486, 0.2814, -0.641, 3.39, -1.277, 5.888, 4.591, 60.55, 8.568, 
              -2.47, -1.449, -0.641, 46.14, -14.49, -4.437, -6.574, -5.478, 
              -37.41, 39.3, 7.437, 2.626, 3.39, -14.49, 68.07, 15.59, 4.792, 
              3.948, 5.403, 37.21, -1.95, -1.473, -1.277, -4.437, 15.59, 219.3
  ), .Dim = c(10L, 10L), .Dimnames = list(c("T0_uhi", "T0_hi", 
                                            "T0_lo", "T0_ulo", "D0", "A0", "Ts", "I0", "day_zero", "b"), 
                                          c("T0_uhi", "T0_hi", "T0_lo", "T0_ulo", "D0", "A0", "Ts", 
                                            "I0", "day_zero", "b")))
